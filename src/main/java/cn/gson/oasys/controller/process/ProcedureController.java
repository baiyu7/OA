...
//        User uuu = udao.findid(username);
    ...
    /**
     * @Author:by on 2019/11/15 0015 16:56
     * @param:session
     * @param:request
     * @param:page
     * @param:size
     ...
     * * 出差申请表单接收
     *
     * @Author:by on 2019/11/15 0015 17:06
     * @param:
     * @return:
     * @Description:
     */
...
//        return "redirect:/xinxeng";
    ...
    /**
     * @param :page
     * @Author:by on 2019/11/15 0015 17:01
     * @param:session
     * @param:request
     * @param:size
     * @return:
...
//        }
    ...
    /**
     * * @Author:by on 2019/11/15 0015 17:02
     *
     * @param :request
     * @param :page
     * @param :size
     ...
     * @param :page
     * @param ：size
     * @Author:by on 2019/11/15 0015 17:04
     * @param:model
     * @return:
     * @Description:
     */
    ...
    /**
     * @Author:by on 2019/11/15 0015 16:43
     * @param:response
     * @param:fileid
     * @Description:
     */
