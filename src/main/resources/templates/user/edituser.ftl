                        ...
                        <div class="row">
                            ...
                            <#if where??>
                                <div class="col-md-6 form-group">
                                    ...
                                    </label> <select id="roleaction" class="form-control" name="roleid">
...
<script type="text/javascript">
    ...
    $("#roleaction").on("click", function () {
        var index = document.getElementById("roleaction").selectedIndex;//获取当前选择项的索引.
        var d = document.getElementById("roleaction").options[index].value;//获取当前选择项的值.
        console.log(d);

        if (d == 3) {
            document.getElementById("deptmanage").style.display = "";

        }else{
            document.getElementById("deptmanage").style.display = "none";
        }
    })
