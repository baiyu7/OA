                ...
                <table class="bo table ">
                    ...
                    <tr class="top ss">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">申请明细</label></div>
                        </td>
                    </tr>
                            ...
                            <div class="out">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.managerAdvice)!''}</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(eve.personnelAdvice)!''}</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
