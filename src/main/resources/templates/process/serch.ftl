            ...
            <div class="box-header">
                <table class="bo table ">
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="underline" style="width:160px;">
                            <div class="bottom"><label class="control-label">${(map.processName)!''}</label></div>
                        </td>
                        <td class="css" style="width:30px;"></td>

                        <td class="wi" style="width: 72px;"><label class="control-label">紧急程度</label></td>
                        <td colspan="4" class="underline" style="width: 60px;">
                            <div class="bottom">${(map.harryname)!''}</div>
                        </td>
                    ...
                    <tr class="top ss">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">报销信息</label></div>
                        </td>
                    </tr>
                    ...
                    <tr class="rile two">
                        ...
                        <td style="width:140px;">
                            <div class="bottom">${(audit.userName)!''}</div>
                        </td>
                        <td class="css" style="width:30px;"></td>
                        <td class="wi" style="width:90px;"><label class="control-label">报销日期</label></td>
                        <td colspan="4" style="width:44px;">
                            <div class="bottom" style="width:148px;">${time}</div>
                        ...
                        <td colspan="4">
                            <div class="bottom">${(bu.allinvoices)!''}</div>
                        </td>
                    ...
                    <tr class="rile">
                        ...
                        <td colspan="4" style="width:44px;">
                            <div class="bottom">${(bu.name)!''}</div>
                        </td>
                        <td class="css" style="width:30px;"></td>
                        <td class="wi" style="width:90px;"><label class="control-label">报销方式</label></td>
                        <td colspan="4">
                    ...
                    <tr class="top">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">报销明细</label></div>
                        </td>
                    </tr>
                    <tr class="rile">
                        <td colspan="14">
                            <div>
                                <table class="table inside">
                                    ...
                                    <#list detaillist as detail>
                                        <tr class="tr">
                                            <td style="border-left: 0px ;" colspan="2"><span>${detail_index+1}</span>
                                            </td>
                            ...
                            <div class="out">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p style="margin-top: 20px;font-size:16px;">${(money)!''}</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(map.processDescribe)!''}</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr class="top">
                        <td colspan="14" class="wi ">
                            <div class="bottom"><label class="control-label font">审批意见</label></div>
                        </td>
                    </tr>
                    <tr class="rile" style="height:70px;">
                        <td colspan="14">
                            <div class="out">
                                <table class="table ob ">
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(bu.managerAdvice)!''}</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13"><p
                                                    style="margin-top: 20px;font-size:16px;">${(bu.financialAdvice)!''}</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr class="fo">
                        ...
                        <td colspan="14" style="text-align: right;">
                            <div class="pull-right foot">
                                ...
                                <#if map.name="审核">
                                    <a class="btn btn-primary huifu" href="auditing?id=${map.proId}&userName=${(audit.userName)!''}">
